...
--
-- Host: 127.0.0.1    Database: dolphin_db
-- ------------------------------------------------------
...
CREATE TABLE `announcement_admin` (
  ...
  PRIMARY KEY (`id`),
  KEY `announcement_admin_announcement_id_foreign` (`announcement_id`),
  ...
  CONSTRAINT `announcement_admin_announcement_id_foreign` FOREIGN KEY (`announcement_id`) REFERENCES `announcements` (`id`) ON DELETE CASCADE
...
CREATE TABLE `announcement_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `announcement_group_announcement_id_foreign` (`announcement_id`),
  KEY `announcement_group_group_id_foreign` (`group_id`),
  CONSTRAINT `announcement_group_announcement_id_foreign` FOREIGN KEY (`announcement_id`) REFERENCES `announcements` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `announcement_organization` (
  ...
  PRIMARY KEY (`id`),
  KEY `announcement_organization_announcement_id_foreign` (`announcement_id`),
  KEY `announcement_organization_organization_id_foreign` (`organization_id`),
  CONSTRAINT `announcement_organization_announcement_id_foreign` FOREIGN KEY (`announcement_id`) REFERENCES `announcements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `announcement_organization_organization_id_foreign` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON DELETE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=153662 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leads` (
  ...
  `organization_size` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_details` (
  ...
  KEY `user_details_country_id_foreign` (`country_id`),
  KEY `user_details_state_id_foreign` (`state_id`),
  ...
  CONSTRAINT `user_details_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `user_details_state_id_foreign` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE SET NULL,
...
-- Dump completed on 2025-10-08 14:10:16
